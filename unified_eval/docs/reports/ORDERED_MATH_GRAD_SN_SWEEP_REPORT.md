# Ordered MATH, Grad, and SN multiplier sweeps

Updated: 2026-08-20

## What was done

The three retained stages were run in order, using both H100s whenever two
...
- Detailed MATH report: `docs/reports/MATH500_L1_L3_N100_EXPERIMENT_REPORT.md`
