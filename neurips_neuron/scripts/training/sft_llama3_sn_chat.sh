#!/usr/bin/env bash
# Native-Llama-3-chat IA3 SFT on the refusal corpus used by SN-Tune.
set -euo pipefail
...
TRAIN_FILE="${TRAIN_FILE:-/workspace/xcy/dataset/projects/iclr_neuron/safety_neuron/training/circuit_breakers_train_first256_llama3_chat.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/workspace/xcy/models/Meta-Llama-3-8B-Instruct-SFT-IA3-SNChat256-E20}"
