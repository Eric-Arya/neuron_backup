...
class HookedPreTrainedModel(PreTrainedModel, GenerationMixin, HookedRootModule):
    ...
    def generate(
        ...
        **kwargs,
        ...
        # The implementation below was copied from an older Transformers
        # release. Delegate to the installed GenerationMixin so generation
        # stays compatible with current cache and validation APIs.
