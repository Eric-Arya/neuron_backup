...
DEFAULT_SOURCE_DIR = DATASET_ROOT / "shared"
...
def main() -> int:
    ...
    advbench_path = args.source_dir / "advbench" / "raw" / "harmful_behaviors.csv"
    harmbench_path = args.source_dir / "harmbench" / "raw" / "behaviors_text_all.csv"
    multijail_path = args.source_dir / "multijail" / "raw" / "MultiJail.csv"
